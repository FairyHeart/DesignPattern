...
import com.创建型模式.工厂方法模式.工厂方法模式.AppleFactory;
import com.创建型模式.工厂方法模式.工厂方法模式.HuaWeiFactory;
import com.创建型模式.工厂方法模式.工厂方法模式.IFactory;
import com.创建型模式.工厂方法模式.简单工厂模式.MobileSimpleFactory;
